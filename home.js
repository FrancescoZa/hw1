...
function onResponse(response){
    ...
    postContent.style.borderColor = "#ccc";
...
function toProfile(){
    ...
    window.open("profile.php?id="+ id,"_self");
...
function displayPost(json, i){
    ...
    if(json.urlNewsImage != null && json.urlNewsImage != 'null'){
...
function onLike(buttonId){
    ...
    fetch('putLike.php?post_id='+postId, {
        method: 'get',
    })
...
function retrievePosts(){
    ...
    .then(onResponse).then(onJSONposts);
...
function generateComment(postId, i, username, datetime, comment){
    ...
    commentCreator.id = "comment_creator"+i;
    document.querySelector("#comment"+i).appendChild(commentCreator);

    const acc_surname = document.createElement("span");
    acc_surname.className = "acc_surname";
    acc_surname.id = "acc_surname"+i;
    acc_surname.innerHTML = "@"+username;
    document.querySelector("#comment_creator"+i).appendChild(acc_surname);

    const date = document.createElement("span");
    date.className = "datetime";
    date.id = "datetime"+i;
    date.innerHTML = "at "+datetime;
    document.querySelector("#comment_creator"+i).appendChild(date);

    const commentContent = document.createElement("div");
    commentContent.className = "comment_content";
    commentContent.id = "comment_content"+i;
    document.querySelector("#comment"+i).appendChild(commentContent);

    const content = document.createElement("span");
    content.innerHTML = comment;
    document.querySelector("#comment_content"+i).appendChild(content);
...
function getComments(postId){
    ...
    fetch('getComments.php?id='+postId, {
        method: 'get',
    }).then(onResponse).then(onJSONGetcomments);
...
function generateRecommendedFriend(i, json){
    ...
    namebtn.onclick = function(){window.open("profile.php?id="+ json.id,"_self");};
